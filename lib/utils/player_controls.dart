...
const kMarkerHeight = 16.0;

// COPY PASTE FROM chewie MaterialDesktopControls.
// Copied for playbar changing
class PlayerControls extends StatefulWidget {
  const PlayerControls({
    this.showPlayButton = true,
    super.key,
    required this.playBarBuilder,
    required this.playBarTop,
  });

  final Widget playBarTop;
  final bool showPlayButton;
  final Widget Function(BuildContext, Widget) playBarBuilder;

  @override
  State<PlayerControls> createState() {
    return _MaterialDesktopControlsState();
  }
}

class _MaterialDesktopControlsState extends State<PlayerControls>
