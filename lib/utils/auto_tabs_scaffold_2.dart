...
/// A scaffold wrapper widget that makes creating an [AutoNavigationRails]
/// much easier and cleaner
class AutoTabsScaffold2 extends StatelessWidget {
    ...
    return AutoTabsRouter(
      ...
      builder: (context, child) {
        ...
        return Scaffold(
          ...
          body: builder?.call(context, tabsRouter, child) ?? child,
